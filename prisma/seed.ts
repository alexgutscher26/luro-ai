...
async function main() {
  ...
  try {
    ...
    if (process.env.NODE_ENV === 'production') {
      console.log('⚠️ Production environment detected. Skipping seed for safety.');
      console.log('💡 To seed production, set FORCE_SEED=true environment variable.');
    ...
    console.log('💡 Use npm run db:studio to view the data in Prisma Studio');
