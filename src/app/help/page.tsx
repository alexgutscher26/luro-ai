                        ...
                        <div className="flex flex-col w-full space-y-8">
                                ...
                                <div className="flex items-center space-x-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">
                                            Find answers to your questions and learn how to make the most of Luro AI
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-muted-foreground mt-1">Our support team is here to assist you</p>
                                </div>
                            ...
                            <Card className="bg-muted/50">
                                <CardContent className="p-6">
                                    <div className="text-center space-y-4">
                                        ...
                                        <p className="text-muted-foreground">Explore more ways to get the most out of Luro AI</p>
