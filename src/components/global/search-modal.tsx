...
import { SearchIcon, FileIcon, UserIcon, SettingsIcon, BarChart3Icon, MegaphoneIcon, CreditCardIcon, XIcon } from "lucide-react";
import {
    Dialog,
    DialogContent,
    DialogHeader,
                            ...
                            <div className="flex flex-col items-center gap-4 text-center max-w-sm">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="text-xs text-muted-foreground leading-relaxed">
                                        Find pages, settings, and features quickly. Try searching for "dashboard", "settings", or "billing".
                                    </div>
                                </div>
