...
const Container: React.FC<{ children: React.ReactNode; delay?: number }> = ({
    children,
    delay = 0,
}) => {
    return (
...
const Realistic: React.FC<{
    autorun: { speed: number; duration: number };
        ...
        const handleSubmit = async (e: React.FormEvent) => {
            ...
            try {
                ...
                if (
                    ...
                    error.response?.data?.error === "already_subscribed"
                ) {
                    toast.info("📧 You're already subscribed!", {
                        description:
                            "Check your inbox for our latest newsletters.",
                        duration: 4000,
                    });
                                ...
                                <Container delay={0.1}>
                                    ...
                                    >
                                        <div className="flex items-center justify-center gap-2 mb-3">
                                            ...
                                            <h3
                                                className={`font-bold heading ${variant === "premium" ? "text-2xl" : "text-lg"}`}
                                            >
                                                Stay in the loop
                                            </h3>
                                        </div>
                                        <p
                                            className={`text-accent-foreground/60 ${variant === "premium" ? "text-base" : "text-sm"}`}
                                        >
                                ...
                                <Container delay={0.2}>
                                    ...
                                    >
                                        {BENEFITS.map((benefit, index) => (
                                            <div
                                                key={index}
                                                className="flex items-center gap-2 text-sm text-accent-foreground/60"
                                            >
                                ...
                                <Container delay={0.4}>
                                    ...
                                    >
                                        <p className="text-xs text-accent-foreground/50">
                                            No spam, unsubscribe at any time. We
