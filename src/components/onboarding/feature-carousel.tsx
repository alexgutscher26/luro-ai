...
const FEATURES: Feature[] = [
    {
        ...
        description: "Generate engaging posts, captions, and hashtags with our advanced AI that understands your brand voice.",
        icon: BrainIcon,
        benefits: [
    ...
    },
    {
        ...
        description: "Track performance, understand your audience, and discover trending content with comprehensive analytics.",
        icon: BarChart3Icon,
        benefits: [
    ...
    },
    {
        ...
        description: "Schedule posts across all platforms and automate your social media workflow for maximum efficiency.",
        icon: CalendarIcon,
        benefits: [
    ...
    },
    {
        ...
        description: "Work seamlessly with your team, manage approvals, and maintain brand consistency across all content.",
        icon: UsersIcon,
        benefits: [
            ...
            <div className="w-full max-w-6xl mx-auto">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                        Explore the powerful features that will transform your social media strategy
                    </p>
                </motion.div>
