...
const SetupForm: React.FC = () => {
    const { nextStep, previousStep, updateUserPreferences, userPreferences } = useOnboarding();
    const [formData, setFormData] = useState({
        ...
        notificationPreferences: {
            ...
            marketing: userPreferences.notificationPreferences?.marketing ?? false,
        },
    ...
    const handleNotificationChange = (type: keyof typeof formData.notificationPreferences, value: boolean) => {
        setFormData(prev => ({
            ...prev,
            notificationPreferences: {
    ...
    const handleSubmit = () => {
        ...
        if (!formData.industry || !formData.teamSize || formData.primaryGoals.length === 0) {
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">Tips, updates, and special offers</p>
                                </div>
                            </div>
                            <Switch
