...
import { SparklesIcon, ArrowRightIcon, RocketIcon, Zap, BarChart3, Brain } from "lucide-react";
            ...
            >
                <div className="text-center space-y-8">
                    ...
                    >
                        ...
                        <Badge variant="secondary" className="bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 border-blue-200 dark:border-blue-800 px-4 py-2">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-300 leading-relaxed max-w-3xl mx-auto">
                            ...
                            <span className="text-blue-600 dark:text-blue-400 font-semibold"> automated workflows</span>, and 
                            <span className="text-purple-600 dark:text-purple-400 font-semibold">data-driven decisions</span>.
                        </p>
                    </motion.div>
