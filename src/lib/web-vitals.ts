...
export const webVitalsReporter = typeof window !== 'undefined' ? new WebVitalsReporter() : null;

// Hook for React components
export const useWebVitals = () => {
  return {
    reportCustomMetric: webVitalsReporter?.reportCustomMetric.bind(webVitalsReporter) || (() => {})
  };
};